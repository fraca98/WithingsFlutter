...
/// [WithingsSleepGetData],[WithingsSleepGetSummaryData]
class WithingsSleepAPIURL extends WithingsAPIURL {
  ...
  /// Generates a [WithingsSleepAPIURL] to get [WithingsSleepGetSummaryData] of a specific date range
  ...
  /// Generates a [WithingsSleepAPIURL] to get [WithingsSleepGetSummaryData] from the last time that data
